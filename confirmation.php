...
<div class="container mx-auto px-4 py-6 sm:py-10 max-w-4xl">
    <div class="confirmation-card" id="confirmationCard">
        ...
        <div class="text-center mb-4">
            ...
            <div class="purchase-id inline-block mt-1">#<?= str_pad($purchase['sale_number'] ?? $purchase['id'], 8, '0', STR_PAD_LEFT) ?></div>
        </div>
        ...
        <div class="card-summary">
            ...
            <div class="mt-3 text-xs text-gray-400 text-right">
                ...
                <span>ID: #<?= str_pad($purchase['sale_number'] ?? $purchase['id'], 8, '0', STR_PAD_LEFT) ?></span>
            </div>
        </div>
        ...
        <div class="info-box mt-4">
            ...
            <p class="flex items-center gap-2 mt-1">
                ...
                <span>Presenta este código en taquilla: <strong class="font-mono">#<?= str_pad($purchase['sale_number'] ?? $purchase['id'], 6, '0', STR_PAD_LEFT) ?>-<?= str_pad($totalTickets, 2, '0', STR_PAD_LEFT) ?></strong></span>
            </p>
        ...
        <div class="btn-actions">
            <a href="user/ticket_pdf.php?purchase_id=<?= (int)$purchaseId ?>" class="print-btn" target="_blank" rel="noopener" title="Descargar comprobante en PDF">
