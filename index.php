...
// ============================================
// ✅ CORREGIDO: LIMPIAR SESSIONSTORAGE AL CERRAR SESIÓN O TIMEOUT
// Ahora también detecta session_expired
// ============================================
...
<script>
// ============================================
// ✅ CORREGIDO: LIMPIAR SESSIONSTORAGE SI ES NECESARIO
// Ahora limpia TODAS las claves relacionadas con compras
// ============================================
<?php if ($shouldClearStorage): ?>
(function() {
// ✅ Prefijos de sessionStorage relacionados con compras
...
'food_created_',
'purchase_token_',
'purchase_expires_at_',
'purchase_token_used_',
'purchase_created_at_',
'ticket_quantities_',
'total_seats_',
'subtotal_',
'tax_amount_',
...
// ✅ Limpiar localStorage (datos sensibles del usuario)
const localPrefixes = [
'cart_',
'user_preference_',
'purchase_history_',
...
if (key) {
const shouldRemove = localPrefixes.some(prefix => key.includes(prefix));
if (shouldRemove) {
...
console.log('✅ LocalStorage limpiado:', localKeysToRemove.length, 'claves eliminadas');
}
})();
<?php endif; ?>
// ============================================
