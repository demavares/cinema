...
if (!isset($_SESSION[$sessionValidKey]) || $_SESSION[$sessionValidKey] !== true) {
    // Limpiar cualquier sesión anterior de este showtime
...
if (!isset($_SESSION[$sessionSeatsKey]) || $_SESSION[$sessionSeatsKey] !== $seats) {
    // Actualizar los asientos en la sesión
...
// ============================================
// IDIOMA DE LA PELÍCULA - CORREGIDO
// ============================================
...
$backUrl = 'food_menu.php?showtime_id=' . $showtimeId . '&seats=' . urlencode($seats);
...
<!-- ============================================ -->
<!-- CSS - ESTILOS ACTUALIZADOS Y FUENTES GRANDES -->
<!-- ============================================ -->
<style>
    ...
    /* Sobrescritura de clases oscuras de Tailwind */
    .bg-\[\#14141e\] {
        background-color: #ffffff !important;
    }
    ...
    /* Detalles del Formulario de Pago */
    ...
    /* CARD-SUMMARY IDÉNTICO A SEATS Y FOOD MENU */
    .card-summary,
    .summary-sticky {
        position: relative;
        top: auto;
...
<div class="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-7xl">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold text-white mb-1">💳 Método de Pago</h2>
        ...
        <div class="w-full lg:w-80 card-summary summary-sticky">
            ...
            <div class="selected-info-box">
                ...
                <div class="mb-3">
                    ...
                    <!-- ✅ IDIOMA EN TEXTO PLANO - CORREGIDO -->
            ...
            <div class="flex flex-col gap-2.5 mt-5">
                ...
                <a href="food_menu.php?showtime_id=<?= $showtimeId ?>&seats=<?= urlencode($seats) ?>" class="btn-back">
...
<!-- ============================================ -->
<!-- TIMEOUT MANAGER - Código centralizado        -->
<!-- ============================================ -->
