...
// ============================================
// ✅ CORRECCIÓN: DESHABILITADO - Permitir múltiples compras por showtime
// ============================================
...
// ============================================
// ✅ CORRECCIÓN: Si no hay datos de tickets pero hay sesión de comida activa,
// recuperar los datos desde la sesión de comida (usuario viene de food_menu o payment)
// ============================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ============================================
    // ✅ CORRECCIÓN: Detectar de dónde viene el usuario
    ...
    const isFromPriceSelection = (fromParam === '' || fromParam === 'price') && (referrer.includes('price_selection.php') || referrer.includes('process_selection.php'));
    ...
    seats.forEach(seat => {
        seat.addEventListener('click', function() {
            ...
            if (blockedSeats.includes(seatId)) { showNotification('Este es un pasillo, no se puede seleccionar', 'warning'); return; }
            if (occupiedSeats.includes(seatId)) { this.classList.add('seat-occupied'); this.disabled = true; showNotification('Este asiento ya ha sido reservado.', 'error'); return; }
            ...
            if (index > -1) {
                ...
                if (selectedSeats.length >= maxSeats) { showNotification('Máximo ' + maxSeats + ' asientos.', 'warning'); return; }
