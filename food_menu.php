...
<!-- ============================================ -->
<!-- CSS - TAMAÑOS DE FUENTE RESTAURADOS          -->
<!-- ============================================ -->
<style>
    ...
    /* CARD-SUMMARY IDÉNTICO A SEATS.PHP */
    .card-summary,
    .summary-sticky {
        position: relative;
        top: auto;
...
<div class="container mx-auto px-2 sm:px-4 py-4 sm:py-8 max-w-7xl">
    ...
    <div class="flex flex-col lg:flex-row gap-6">
        ...
        <div class="flex-1 min-w-0">
            <h2 class="text-2xl font-bold text-white mb-1">🍿 Elige tu comida</h2>
...
function goToPayment() {
    ...
    .then(data => {
        window.location.href = 'payment.php?showtime_id=' + showtimeId + '&seats=' + encodeURIComponent(seats);
    })
    .catch(error => {
        window.location.href = 'payment.php?showtime_id=' + showtimeId + '&seats=' + encodeURIComponent(seats);
    });
