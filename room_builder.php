...
<head>
    ...
    <style>
        ...
        .row-controls .btn-row-select:hover {
            background: #4338ca;
        }

        .row-controls .btn-row-select.active {
            background: #6366f1;
        }
        ...
        .row-controls .btn-row-delete:hover {
            background: #b91c1c;
        }
...
title="Eliminar último asiento de esta fila">-</button>`;
        ...
        function addSingleRow() {
            ...
            state.seatMap[nextLetter] = Array.from({
                length: seatsPerRow
            }, (_, i) => i + 1);
